...
class InvestmentGroupTests(unittest.TestCase):
    def test_all_primary_group_patterns(self):
        ...
        self.assertEqual(investment_group(50, 45, 80), "Price Ahead of Fundamentals")
        ...
        self.assertEqual(investment_group(55, 52, 55), "Strong Signals, Weak Price")
    ...
    def test_boundary_values_are_deterministic(self):
        ...
        self.assertEqual(investment_group(59.9, 50, 60), "Price Ahead of Fundamentals")
