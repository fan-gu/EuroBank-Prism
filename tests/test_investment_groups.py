...
class InvestmentGroupTests(unittest.TestCase):
    def test_all_primary_group_patterns(self):
        ...
        self.assertEqual(investment_group(80, 75, 49), "Re-rating Candidates")
        self.assertEqual(investment_group(75, 45, 45), "Contrarian Value")
        self.assertEqual(investment_group(50, 45, 80), "Price-led Momentum")
        self.assertEqual(investment_group(40, 75, 50), "Verification Watch")
    ...
    def test_boundary_values_are_deterministic(self):
        ...
        self.assertEqual(investment_group(50, 50, 49.9), "Re-rating Candidates")
        self.assertEqual(investment_group(50, 49.9, 40), "Contrarian Value")
        self.assertEqual(investment_group(59.9, 50, 60), "Price-led Momentum")
    ...
    def test_review_examples_keep_all_three_axes_informative(self):
        ...
        self.assertEqual(investment_group(50.1, 57.3, 18.7, gates), "Re-rating Candidates")
        self.assertEqual(investment_group(38.8, 69.8, 44.8, gates), "Verification Watch")
        self.assertEqual(investment_group(54.8, 49.7, 2.2, gates), "Downside Risk")
        self.assertEqual(investment_group(55.1, 40.4, 47.4, gates), "Contrarian Value")
